...
class ApiInputTests(TestCase):
    ...
    def test_assign_orders_empty(self):
        """
    ...
    def test_assign_orders_no_courier(self):
        """
        Тест на HTTP 400 при невалидном courier_id
        """
    ...
    def test_complete_order_wrong_courier(self):
        """
        Ошибка если курьер не соответствует заказу
        """
...
class CheckAfterAssignTests(TestCase):
    ...
    def test_patch_incompatible_orders(self):
        """
        Проверяет случай, когда изменение данных о курьере вынуждает снять с него некоторые заказы
        """
...
class CalculationTests(TestCase):
    ...
    def test_getInfo_no_rating(self):
        """
